...
if st.sidebar.button("Gerar base", type="primary"):
    with st.spinner("Carregando..."):
        ...
        # ===============================================
        # Cria uma lista com os dados do último registro do DataFrame
        ...
        dados_teste = [
            ...
            [
                ...
                "ALMIR MARTINS",
                "DIAS____",  # 2
                "almir.martinslopes@jci.com",  # 3
                "TITULO",  # 4
                "MES____________",  # 5
                "VALOR_LIQUIDO_______",  # 6
                "VENCIMENTO",  # 7
                # "LINHA_DIGITAVEL",
                "NOTA_FISCAL",  # 8
                # "LINK_FATURA_______",
        ...
        for dados in dados_teste:
            aux = lista[-1].copy()  # Copia os dados do último registro
            dados[2] = aux[2]
            dados[4] = aux[4]
            dados[5] = aux[5]
            dados[6] = aux[6]
    ...
    with st.spinner("Carregando..."):
        ...
        dados_teste = [
            ...
            [
                ...
                "ALMIR MARTINS",
                "DIAS____",
                "almir.martinslopes@jci.com",  # "tatiane.1.pereira-ext@jci.com",
                "TITULO",
                "MES____________",
                "VALOR_LIQUIDO_______",
                "VENCIMENTO",
