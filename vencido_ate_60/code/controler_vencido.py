...
import time
import pandas as pd
from model_vencido import BancoDeDados
...
class Controlador:
    ...
    def exporta_zenvia(self, df):
        ...
        df_modificado = df.copy()
        df_modificado["CODCAMPANHA"] = "RECFINANBLT0011"
        ...
        # # =================================
        # df_modificado["Whatsapp"] = "5511988720320"  # 5511973600888 5511988720320
        ...
        dados = os.path.join(
            ...
            "..",
            "dados",
            f'Títulos vencidos {time.strftime("%d-%m-%Y %Hh%Mm")}.csv',
        )
    ...
    def send_email(self, from_mail, df):
        ...
        for index, row in df.iterrows():
            ...
            assunto = "Atenção: título vencido"
            ...
            try:
                ...
                print(f"Ocorreu um erro: STATUS {response} \n{e}")
