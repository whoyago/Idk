...
# =======================================================================
# Título da página
st.title("🤖 TÍTULOS VENCIDOS ATÉ 60 DIAS")
# st.markdown("## 🤖 TÍTULOS VENCIDOS ATÉ 60 DIAS")
    ...
    with st.spinner("Carregando..."):
        ...
        dados_teste = [
            ...
            [
                "237495",
                "TATIANE PEREIRA",
                "tatiane.1.pereira-ext@jci.com",  # "tatiane.1.pereira-ext@jci.com",
                "TITULO",
                "VENCIMENTO",
                "LINHA_DIGITAVEL",
                "NOTA_FISCAL",
